...
const THEMES = [
    ...
    { id: 'slate-monochrome', name: 'Slate Mono', bg: '#18181B', text: '#FAFAFA', border: '#3F3F46', photoBg: '#27272A' },
];
            ...
            <div className="relative z-10 max-w-md mx-auto space-y-6">
                ...
                {photos.length === 4 && (
                    <div className="space-y-4 pt-4 border-t border-slate-800">
                        ...
                        <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-none">
                            {THEMES.map((theme) => (
                                <button
                                    ...
                                    className={`px-3.5 py-2 rounded-xl text-xs font-medium border transition-all flex items-center gap-2 shrink-0 backdrop-blur-md ${selectedTheme.id === theme.id
                        ...
                        >
                            <div className="text-center text-[10px] uppercase font-bold tracking-widest opacity-50">
                                • PHOTO BOOTH •
                            </div>
                            ...
                            <div className="space-y-3">
                                {photos.map((src, i) => (
                                    <div
                                        key={i}
                                        className="p-1.5 rounded-xl shadow-inner overflow-hidden"
